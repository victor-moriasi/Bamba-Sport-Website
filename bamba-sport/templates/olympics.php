			...
			<main id="main" class="site-main" role="main">
				...
				<div class="row">
					<div class="col-md-12" style="margin-top: 2em;">
						<h2>Olympic Widgets</h2>
						<div class="olympic_widget">
							<h3 class="olympic_title">
								Olympic Medal Table Widget
							</h3>
							<opta widget="medal_table" sport="olympics" competition="1" season="2016" show_flag="true" show_total="true" medal_breakdown="true" expand_default="false" limit="10" hide_zeroes="false" live="true" narrow_limit="400" opta_logo="false"></opta>
						</div>
						...
						<div class="olympic_widget">
							...
							<opta widget="medal_ticker" sport="olympics" competition="1" season="2016" show_flag="true" show_time="true" live="true" narrow_limit="400" opta_logo="true"></opta>
						</div>
						...
						<div class="olympic_widget">
							...
							<opta widget="schedule" sport="olympics" competition="1" season="2016" grouping="sport" show_grouping="true" disciplines="" start_current_day="true" time_format="HH:mm" date_picker_format="ddd dd MMM" show_venue="true" live="true" narrow_limit="400" opta_logo="false">
